...
module.exports.bootstrap = function(cb) {
  ...
  User.findOne({username:'transportacion'}).exec(function(err,found){
	  	if(err){return res.json(400,err);}
	  	if(found == null){
	  		var newUser= {}; 
	  		newUser.username = 'transportacion';
	  		newUser.password = 'transportacion';
	  		newUser.passwordChangeDate = new Date();
	  		newUser.isActive = true;
	  		newUser.email = 'transportacion@reaco.com';
